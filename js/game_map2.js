...
// create game scene
export class TankBattle_MAP2 extends Phaser.Scene {
    sounds = {};
    constructor() {
        super('TankBattle_MAP2');
    }
    ...
    initGame() {
        ...
        backButton.on('pointerdown', () => {
            ...
            this.scene.stop('TankBattle_MAP2');
        });
    ...
    preload() {
        //Tilemap
        this.load.tilemapTiledJSON('map', 'assets/maps/map2/map2_tiled.json');
        this.load.image('map2_tileimg', 'assets/maps/map2/map2(FIT).png');
    ...
    create() {
        ...
        const tileset = map.addTilesetImage('map2(FIT)', 'map2_tileimg');
    ...
    collectStar(player, star) {
        ...
        this.score += 50;
        this.scoreText.setText('Score: ' + this.score); //updata score
    }
